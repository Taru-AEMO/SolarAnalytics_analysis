...
directory <- "~/GitHub/DER_Event_analysis/SolarAnalytics_analysis/output/All_Event_Results/4500"
...
underlying_data_file <- "20171209_underlying.csv"
...
upscaled_aggregated_file <- "20171209_upscale.csv"
...
event_time <- c("10:15:55", "10:16:25")
